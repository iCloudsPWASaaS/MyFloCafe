...
exports.PRINT_LABEL_LANGUAGES = void 0;
exports.printLabel = printLabel;
exports.isGeneratedPrintLanguage = isGeneratedPrintLanguage;
exports.PRINT_LABEL_LANGUAGES = [
    'en',
    'fa',
    'es',
    'fr',
 ...
 */
function printLabel(lang, conceptId) {
    const table = PRINT_LABELS[lang];
    return table?.[conceptId] ?? PRINT_LABELS.en[conceptId];
}
/** True when the generated view carries a dedicated table for `lang`. */
function isGeneratedPrintLanguage(lang) {
    return PRINT_LABELS.hasOwnProperty(lang);
}
//# sourceMappingURL=print-labels.generated.js.map