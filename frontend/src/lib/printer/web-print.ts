...
export function generateBillHtml(
  ...
  const L = {
    ...
    deliveryAddress: printLabelResolver('pos.deliveryAddress', lang),
  ...
  <div class="bill-container">
    ...
    <div class="bill-details">
      <table>
        ...
        ${customer?.address ? `<tr><td><strong>${escapeHtml(L.deliveryAddress)}</strong> ${escapeHtml(customer.address.text)}</td><td></td></tr>` : ''}
      </table>
    </div>
